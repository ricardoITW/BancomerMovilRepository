...
public class ConfirmarNvaCtaOtrosBancos extends BaseClass{

	public ConfirmarNvaCtaOtrosBancos(AndroidDriver driver) {
		super(driver);
	...
	//static By LblReferencia = By.xpath("//android.widget.TextView[@resource-id='com.bancomer.mbanking:id/cyr_lista_celda_2' and @text='"+Referencia+"']");
	//static By LblConcepto = By.xpath("//android.widget.TextView[@resource-id='com.bancomer.mbanking:id/cyr_lista_celda_2' and @text='"+Concepto+"']");
	//static By LblFecha = By.xpath("//android.widget.TextView[@resource-id='com.bancomer.mbanking:id/cyr_lista_celda_2' and @text='"+Fecha+"']");
